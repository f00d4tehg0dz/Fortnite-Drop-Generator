const { spawnitems } = require('../randomspawn.json');
...
module.exports = {
	...
	execute(message) {
		...
		const embed = {
			...
			'thumbnail': {
				'url': 'https://f00d.me/fortnite/images/' + `${image}` + '.png',
			},
			'image': {
				'url': 'https://f00d.me/fortnite/images/' + `${image}` + '.png',
			},
			'author': {
				'name': 'Fornite Generator',
				'url': 'https://f00d.me/fortnite',
				'icon_url': 'https://f00d.me/fortnite/images/fbimage2.png',
			},
		};
